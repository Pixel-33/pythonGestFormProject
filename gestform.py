...
def run_gestform():
    ...
    nb_element = input("Veuillez renseigner le nombre d'éléments que vous souhaitez tester (MIN 1 / MAX 10000) : ")
    ...
    try:
        ...
        # Récupération de la liste aléatoire des entiers dans la variable "my_list"
